...
const RULES: readonly IntentRule[] = [
  { intent: "profile", phrases: ["who are you", "who is krishna", "what is your name", "what's your name", "what is your full name", "tell me about yourself", "tell me about krishna"], keywords: ["name", "identity", "profile", "yourself", "krishna", "engineer"] },
  { intent: "skills", phrases: ["what technologies do you use", "what is your tech stack", "what's your tech stack", "do you know react", "do you know ruby on rails", "what backend technologies do you use"], keywords: ["skill", "skills", "technology", "technologies", "stack", "react", "redux", "ruby", "rails", "flutter", "node", "typescript", "tailwind", "docker", "aws", "kubernetes", "postgresql", "mysql", "redis", "backend", "frontend", "programming", "framework", "certification"] },
  { intent: "projects", phrases: ["show me your work", "what have you built", "what projects have you worked on", "show me your projects"], keywords: ["project", "projects", "portfolio", "built", "builds", "case study", "golf buddy", "popmenu", "juubix", "kairos"] },
  { intent: "experience", phrases: ["where have you worked", "what is your experience", "tell me about your experience", "work history", "who do you work for"], keywords: ["experience", "career", "employer", "worked", "employment", "professional", "history", "sampo", "uni-ty", "daanfe"] },
  ...
  { intent: "contact", phrases: ["what is your email", "what's your email", "what is your phone number", "how can i contact you", "how can i reach you", "how can i reach krishna", "get in touch"], keywords: ["contact", "email", "phone", "call", "reach", "github", "social", "message", "connect", "available"] },
  { intent: "interests", phrases: ["what do you love", "what are your hobbies", "what are your interests", "beyond programming", "do you like cinema", "do you like philosophy", "tell me about psychology"], keywords: ["interest", "interests", "hobby", "hobbies", "love", "passion", "book", "books", "literature", "philosophy", "cinema", "film", "movies", "psychology", "writing", "poetry", "content"] },
];
